...
class SalgueiroPage extends StatefulWidget{
  @override
  State<SalgueiroPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<SalgueiroPage> {
  int counter = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('SALGUEIRO', style: TextStyle(fontSize: 30,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: [
            ...
            child: Image.asset('assets/imagens/03.salgueiro.png', fit: BoxFit.cover)),
  
            Text(
            textAlign: TextAlign.center,
            'A 513 km do Recife, Salgueiro se apresenta como o coração do sertão pernambucano! Terra da  Cachaçaria Serrote e do carnaval com a Bicharada do Mestre Jaime.', 
