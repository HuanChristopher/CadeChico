...
class GaranhunsMosteiroPage extends StatefulWidget{
  @override
  State<GaranhunsMosteiroPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<GaranhunsMosteiroPage> {
  int counter = 0;
 ...
 void _stopMusic() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('MOSTEIRO DE SÃO BENTO', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            'O mosteiro foi fundado em 1940 pelos monges beneditinos, com o objetivo de servir como um centro de espiritualidade e formação religiosa na região do Agreste de Pernambuco.', 
              ...
              Column(
                children: [
                  MaterialButton(
                                ...
                                onPressed: () {
                                    _audioPlayer.stop();
                                    Navigator.of(context).pushReplacementNamed('/viagem09');   
                                }, 
