...
class OlindaQuatroPage extends StatefulWidget{
  @override
  State<OlindaQuatroPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<OlindaQuatroPage> {
  int counter = 0;
 ...
 void _stopMusic() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('QUATRO CANTOS', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
        ...
        child: Column(
          ...
          children: <Widget>[
           Text(
            ...
            child: Image.asset('assets/imagens/05.olinda.quatrocantos2.png', fit: BoxFit.cover)),
  
            Text(
            textAlign: TextAlign.center,
            'Os Quatro Cantos é uma das áreas mais emblemáticas de Olinda. Este cruzamento emblemático oferece uma janela para o passado colonial da cidade enquanto serve como um centro dinâmico de vida cultural e social.', 
