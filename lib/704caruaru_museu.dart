...
class CaruaruMuseuPage extends StatefulWidget{
  @override
  State<CaruaruMuseuPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<CaruaruMuseuPage> {
  int counter = 0;
 ...
 void _stopMusic() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('MUSEU DO FORRÓ\nLUIZ GONZAGA', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            child: Image.asset('assets/imagens/08.caruaru.museu2.png', fit: BoxFit.cover)),
  
            Text(
            textAlign: TextAlign.center,
            'Inaugurado em 1985, em um esforço para homenagear Luiz Gonzaga e perpetuar a memória do forró e de outros ritmos nordestinos.', 
