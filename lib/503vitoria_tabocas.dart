...
class VitoriaTabocasPage extends StatefulWidget{
  @override
  State<VitoriaTabocasPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<VitoriaTabocasPage> {
  int counter = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('MONTE DAS TABOCAS', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            'Em 3 de agosto de 1645, os luso-brasileiros, liderados por João Fernandes Vieira, Felipe Camarão e Henrique Dias, venceram as forças holandesas no Monte das Tabocas.', 
