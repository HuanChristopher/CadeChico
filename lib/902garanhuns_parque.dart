...
class GaranhunsParquePage extends StatefulWidget{
  @override
  State<GaranhunsParquePage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<GaranhunsParquePage> {
  int counter = 0;
 ...
 void _stopMusic() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('PARQUE DOS EUCALÍPTOS', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            child: Image.asset('assets/imagens/06.vitoria.tabocas2.png', fit: BoxFit.cover)),
  
            Text(
            textAlign: TextAlign.center,
            'Conhecido como Parque dos Eucaliptos,foi inaugurado em 1935 e leva o nome de Euclides Dourado, um importante cidadão local que contribuiu significativamente para o desenvolvimento de Garanhuns.', 
              ...
              Column(
                 children: [
                  MaterialButton(
                                ...
                                onPressed: () {
                                  _audioPlayer.stop();
                                  Navigator.pushNamed(context, '/garanhunsExplorar'); 
