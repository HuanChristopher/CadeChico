...
class GaranhunsCasteloPage extends StatefulWidget{
  @override
  State<GaranhunsCasteloPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<GaranhunsCasteloPage> {
  int counter = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('CASTELO DE JOÃO CAPÃO', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            'O castelo foi idealizado e construído em 1970 por João Ferreira, conhecido como João Capão, um ex-militar e artista autodidata', 
