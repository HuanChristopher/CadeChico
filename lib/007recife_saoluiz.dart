...
class RecifeSaoLuizPage extends StatefulWidget{
  @override
  State<RecifeSaoLuizPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<RecifeSaoLuizPage> {
  int counter = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('CINEMA SÃO LUIZ', style: TextStyle(fontSize: 30,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
