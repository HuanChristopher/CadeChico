...
class SalgueiroSitioPage extends StatefulWidget{
  @override
  State<SalgueiroSitioPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<SalgueiroSitioPage> {
  int counter = 0;
 ...
 void _stopMusic() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Sítio Arqueológico Serra das Letras', style: TextStyle(fontSize: 18,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
