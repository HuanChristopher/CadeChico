...
class VitoriaExplorarPage extends StatefulWidget{
  @override
  State<VitoriaExplorarPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<VitoriaExplorarPage> {
  int counter = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('ANDANDO POR VITÓRIA', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
          ...
          children: <Widget>[
            ...
            Column(
              children: [
                ...
                Text('Monte das Tabocas', textAlign: TextAlign.center, style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold),),
              ],
            ),
            ...
            Row(
              ...
              Column(
                children: [
                  MaterialButton(
                               ...
                               Text('Praça Leão Coroado', textAlign: TextAlign.center, style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold),),
                ],
              ),
              ...
              Column(
                children: [
                  ...
                  Text('Praça do Jacaré', textAlign: TextAlign.center, style: TextStyle(fontSize: 20, color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold,),),
                ],
              ),
