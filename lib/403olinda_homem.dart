...
class OlindaHomemPage extends StatefulWidget{
  @override
  State<OlindaHomemPage> createState() {
...
class HomePageState extends State<OlindaHomemPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('HOMEM DA MEIA-NOITE', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            child: Image.asset('assets/imagens/05.olinda.homemmeianoite.png', fit: BoxFit.cover)),
  
            Text(
            textAlign: TextAlign.center,
            'O Homem da Meia-Noite é uma das figuras mais emblemáticas e queridas do Carnaval de Olinda. Este icônico boneco gigante é uma peça central das festividades carnavalescas da cidade.', 
