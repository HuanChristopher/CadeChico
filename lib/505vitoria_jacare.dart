...
class VitoriaJacarePage extends StatefulWidget{
  @override
  State<VitoriaJacarePage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<VitoriaJacarePage> {
  int counter = 0;
 ...
 void _stopMusic() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('PRAÇA DO JACARÉ', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            child: Image.asset('assets/imagens/06.vitoria.jacare2.png', fit: BoxFit.cover)),
