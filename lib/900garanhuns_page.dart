...
class GaranhunsPage extends StatefulWidget{
  @override
  State<GaranhunsPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<GaranhunsPage> {
  int counter = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('GARANHUNS', style: TextStyle(fontSize: 30,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            child: Image.asset('assets/imagens/09.garanhus.png', fit: BoxFit.cover)),
  
            Text(
            textAlign: TextAlign.center,
            'Conhecida como "Suíça Pernambucana" devido ao seu clima ameno e características geográficas, Garanhuns é um dos destinos mais atraentes do Agreste pernambucano.', 
