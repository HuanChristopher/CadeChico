...
class RecifeUFRPEPage3 extends StatefulWidget{
  @override
  State<RecifeUFRPEPage3> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<RecifeUFRPEPage3> {
  int counter = 0;
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            child: Image.asset('assets/imagens/01.recifeGil03.png', fit: BoxFit.cover)),
                                ...
                                onPressed: () {
                                  context.read<TimeProvider>().addOneHour();
                                   if(GlobalVariables.isGameOver){
                                        ...
                                        _audioPlayer.stop();
                                        Navigator.pushNamed(context, '/recife_ufrpe4');  }
