...
class Tutorial03Page extends StatefulWidget{
  @override
  State<Tutorial03Page> createState() {
      ...
      body: SizedBox( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            'Quando reunir as informações que precisa, você poderá viajar para outro municipio clicando em Viajar. Cada viagem também custa tempo.', 
              ...
              Column(
                children: [
                  MaterialButton(
                                ...
                                child: Image.asset('assets/icones/map-marker2.png', fit: BoxFit.cover, width: 50, height: 50,), 
                              ),

                               SizedBox(height: 10),

                             
                               Text('VIAJAR', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 248, 42, 5),fontWeight: FontWeight.bold),),
                ],
              ),
