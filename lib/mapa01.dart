...
class Mapa01Page extends StatefulWidget{
  @override
  State<Mapa01Page> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<Mapa01Page> {
  int counter = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('VIAJANDO', style: TextStyle(fontWeight: FontWeight.bold,)), 
