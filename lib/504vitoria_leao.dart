...
class VitoriaLeaoPage extends StatefulWidget{
  @override
  State<VitoriaLeaoPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<VitoriaLeaoPage> {
  int counter = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('PRAÇA LEÃO COROADO', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            child: Image.asset('assets/imagens/06.vitoria.leao2.png', fit: BoxFit.cover)),
  
            Text(
            textAlign: TextAlign.center,
            'O monumento Leão Coroado é uma homenagem à Revolução Pernambucana de 1817, onde Pernambuco se consolidou país por 75 dias.', 
