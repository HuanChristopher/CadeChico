...
class RecifeUFRPEPage5 extends StatefulWidget{
  @override
  State<RecifeUFRPEPage5> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<RecifeUFRPEPage5> {
  int counter = 0;
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            child: Image.asset('assets/imagens/01.recifeGil05.png', fit: BoxFit.cover)),
                ...
                children: [
                  MaterialButton(
                                ...
                                onPressed: () {
                                    ...
                                    Navigator.pushNamed(context, '/recife_ufrpe6');}
