...
class AfogadosSitioPage extends StatefulWidget{
  @override
  State<AfogadosSitioPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<AfogadosSitioPage> {
  int counter = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('SÍTIO ARQUELÓGICO\nDA SERRA DO GIZ', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            child: Image.asset('assets/imagens/07.afogados.sitio2.png', fit: BoxFit.cover)),
  
            Text(
            textAlign: TextAlign.center,
            ' As inscrições encontradas nas rochas da Serra do Giz  incluem figuras geométricas, antropomórficas e zoomórficas, além de símbolos abstratos usados por povos pré-históricos', 
