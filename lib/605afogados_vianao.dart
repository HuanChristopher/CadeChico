...
class AfogadosVianaoPage extends StatefulWidget{
  @override
  State<AfogadosVianaoPage> createState() {
    return HomePageState();
  }

}

class HomePageState extends State<AfogadosVianaoPage> {
  int counter = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('VIANÃO', style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 31, 100, 255),fontWeight: FontWeight.bold)), 
      ...
      body: Container( 
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            child: Image.asset('assets/imagens/07.afogados.vianao.png', fit: BoxFit.cover)),
  
            Text(
            textAlign: TextAlign.center,
            'O Estádio Municipal Valdemar Viana de Araújo, mais conhecido por Vianão, é a casa do Afogados da Ingazeira Futebol Clube, um dos principais clubes de futebol da região.', 
